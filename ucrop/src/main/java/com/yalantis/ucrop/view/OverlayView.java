...
public class OverlayView extends View {
    ...
    private boolean customCropViewRect = false;
    ...
    public void setupCropBounds() {
        ...
        if (customCropViewRect && mThisWidth > 0 && mThisHeight > 0) {
            if (height > mThisHeight) {
                int width = (int) (mThisHeight * mTargetAspectRatio);
                int halfDiff = (mThisWidth - width) / 2;

                mCropViewRect.left += getPaddingLeft() + halfDiff;
                mCropViewRect.right += getPaddingLeft() + halfDiff;
                ...
                mCropViewRect.top += getPaddingTop() + halfDiff;
                mCropViewRect.bottom += getPaddingTop() + halfDiff;
            }
        } else {
            if (height > mThisHeight) {
                int width = (int) (mThisHeight * mTargetAspectRatio);
    ...
    protected void processStyledAttributes() {
        ...
        mDimmedColor = getResources().getColor(R.color.ucrop_color_default_dimmed);
